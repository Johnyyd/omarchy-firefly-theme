...
-- Source: /omarchy-firefly-theme/hyprland.conf

local activeBorderColor = {
  colors = { "rgba(8FA4ABff)", "rgba(BAC8B1cc)", "rgba(6F9C97aa)" },
  angle = 35,
}
local inactiveBorderColor = "rgba(35313C99)"
local shadowColor = "rgba(35313C8c)"
...
hl.curve("fireflyFloat", { type = "bezier", points = { { 0.22, 0.9 }, { 0.2, 1.0 } } })
hl.curve("fireflyDrift", { type = "bezier", points = { { 0.3, 1.05 }, { 0.38, 1.0 } } })
